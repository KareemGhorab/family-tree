  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "dialog-max-height bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 flex w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] flex-col rounded-lg border shadow-lg duration-200 outline-none sm:max-w-lg",
          className
        )}
        {...props}
      >
        <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden p-6 pr-12">
          {children}
        </div>
        {showCloseButton && (
